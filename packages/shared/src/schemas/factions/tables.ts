...
export const factionRegions = sqliteTable("faction_regions", {
	id: pk(),
...
export const factionHeadquarters = sqliteTable("faction_headquarters", {
	id: pk(),
	factionId: cascadeFk("faction_id", factions.id),
...
export const factionOperations = sqliteTable("faction_operations", {
	id: pk(),
	factionId: cascadeFk("faction_id", factions.id),
	name: string("name").unique(),
...
export const factionCulture = sqliteTable("faction_culture", {
	id: pk(),
	factionId: cascadeFk("faction_id", factions.id),
