...
export const questRelations = sqliteTable("quest_relations", {
	id: pk(),
...
export const stageDecisions = sqliteTable("stage_decisions", {
	id: pk(),
	questId: cascadeFk("quest_id", quests.id),
...
export const decisionConsequences = sqliteTable("decision_consequences", {
	id: pk(),
