...
export const getDangerTooltip = (level: string | null | undefined) => {
	switch (level) {
		case "safe": return "Safe for inhabitants";
		case "low": return "Minor threats present";
		case "moderate": return "Significant dangers";
		case "high": return "Very dangerous";
		case "deadly": return "Extremely deadly";
		default: return "Danger level unknown";
	}
}
