...
// Path to the file
const filePath = join(process.cwd(), "src", "database", "operations", "locations.ts")
...
console.log("Fixing parameter passing in Locations operations...")
...
console.log("Location operations file has been fixed successfully!") 