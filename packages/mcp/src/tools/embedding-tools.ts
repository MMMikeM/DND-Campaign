...
> = {
	...
	location: { table: tables.regionTables.locations, nameColumn: tables.regionTables.locations.name },
	location_encounter: {
		table: tables.regionTables.locationEncounters,
		nameColumn: tables.regionTables.locationEncounters.name,
	},
	location_secret: { table: tables.regionTables.locationSecrets },
...
const generateEmbeddingHandler: ToolHandler = async (args) => {
	try {
		...
		const queryMap = {
			...
			location: db.query.locations,
			location_encounter: db.query.locationEncounters,
			location_secret: db.query.locationSecrets,
			item: db.query.items,
			clue: db.query.clues,
